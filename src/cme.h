...
string const   PROGRAM_NAME                                                = "CoastalME 0.9.9 TESTING - 14 March 2018";
...
int const      RTN_ERR_BADPROFILE                     = 28;
int const      RTN_ERR_NOPROFILES                     = 29;
int const      RTN_ERR_NOSEACELLS                     = 30;
int const      RTN_ERR_GRIDTOLINE                     = 31;
int const      RTN_ERR_FINDCOAST                      = 32;
int const      RTN_ERR_NOCOAST                        = 33;
int const      RTN_ERR_MASSBALANCE                    = 34;
...
int const      RTN_ERR_NO_SEAWARD_END_OF_PROFILE      = 41;
// int const      RTN_ERR_BAD_BEACH_DEPOSITION_PROFILE   =;
int const      RTN_ERR_LANDFORM_TO_GRID               = 42;
int const      RTN_ERR_NO_TOP_LAYER                   = 43;
int const      RTN_ERR_NO_ADJACENT_POLYGON            = 44;
int const      RTN_ERR_BAD_MULTILINE                  = 45;
int const      RTN_ERR_CANNOT_INSERT_POINT            = 46;
int const      RTN_ERR_CANNOT_ASSIGN_COASTAL_LANDFORM = 47;
int const      RTN_ERR_SHADOW_ZONE_FLOOD_FILL_NOGRID  = 48;
int const      RTN_ERR_SHADOW_ZONE_FLOOD_START_POINT  = 49;
int const      RTN_ERR_CSHORE_EMPTY_PROFILE           = 50;
int const      RTN_ERR_CSHORE_OUTPUT_FILE             = 51;
...
int const      RTN_ERR_ESTIMATED_EROSION_IS_ZERO      = 57;
